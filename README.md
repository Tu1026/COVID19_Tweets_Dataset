...
* Not all keywords were tracked from the very beginning. As news about the novel coronavirus spread, additional keywords were added to the search list. A few keywords tracked in the beginning were also removed. 
* Only tweets in English were collected until 31 January 2020, after which the algorithm collected tweets in all languages. 
