...
---
title: "COVID-19 Multilanguage Tweets Dataset"
output:
  md_document:
    variant: gfm
params:
...
## Data Statistics
The following data is from Tweets colectled until **`r params$date`**. (`r params$version`)

Number of Tweets: **`r params$tweetsNumber`**

Number of Original Tweets: **`r params$originalTweetsNumber`**

Number of Re-Tweets: **`r params$retweetsNumber`**


Tweets Breakdown by Month:

```{r echo=FALSE, results="asis"}
month = read.csv(here("analysis", "paper", "data", "table4.csv"))
kable(month)
```
...
```{r echo=FALSE, results="asis"}
keywords = read.csv(here("analysis", "paper", "data", "table5.csv"))
kable(keywords)
```

Tweets By Language:
```{r echo=FALSE, results="asis"}
languages = read.csv(here("analysis", "paper", "data", "table2.csv"))
kable(languages)
```

```{r pressure, echo=FALSE, out.width = '100%',fig.cap="Number of tweets a day by language for the keyword 'coronavirus'."}
knitr::include_graphics('https://github.com/lopezbec/COVID19_Tweets_Dataset/blob/master/analysis/paper/images/language_coronavirus.png')
```
```{r, echo=FALSE, out.width = '100%', fig.cap="Geolocated tweets for the keyword 'coronavirus'"}
knitr::include_graphics('https://github.com/lopezbec/COVID19_Tweets_Dataset/blob/master/analysis/paper/images/geotweets_coronavirus.png')
```
```{r, echo=FALSE, out.width = '100%', fig.cap="Average sentiment of tweets for the observation period grouped by keyword."}
knitr::include_graphics('https://github.com/lopezbec/COVID19_Tweets_Dataset/blob/master/analysis/paper/images/sentiment.png')
```
## Inquiries
