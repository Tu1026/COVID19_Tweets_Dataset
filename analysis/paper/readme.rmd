...
```{r pressure, echo=FALSE, out.width = '100%',fig.cap="Number of tweets a day by language."}
knitr::include_graphics('https://github.com/lopezbec/COVID19_Tweets_Dataset/blob/master/analysis/paper/images/language.png')
```
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics('https://github.com/lopezbec/COVID19_Tweets_Dataset/blob/master/analysis/paper/images/geotweets.png')
```
